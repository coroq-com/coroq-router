...
class PlaceholderRuleTest extends TestCase {
  ...
  public function testAlphaType(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['page', 'name'], $result->segments);
    $this->assertSame(['name' => 'about'], $result->params);

    // Per-segment matching: 'about123' is not fully alpha, no match
  ...
  public function testAlnumType(): void {
    ...
    // Per-segment matching: 'abc-123' contains '-', not fully alnum, no match
  ...
  public function testHexType(): void {
    ...
    // Per-segment matching: '5g3a' contains 'g', not fully hex, no match
  ...
  public function testMultiplePlaceholders(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['user', 'userid', 'post', 'postid'], $result->segments);
  ...
  public function testMultiplePlaceholdersInOneSegment(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['file', 'name.ext'], $result->segments);
  ...
  public function testDatePattern(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['archive', 'year-month-day'], $result->segments);
  ...
  public function testPrefixMatch(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['user', 'id', 'extra'], $result->segments);
    $this->assertSame(['id' => '123'], $result->params);
  ...
  public function testPrefixBeforePlaceholder(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['prefixx'], $result->segments);
  ...
  public function testSuffixAfterPlaceholder(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['xsuffix'], $result->segments);
    $this->assertSame(['x' => 'value'], $result->params);
  }
  ...
  public function testPrefixAndSuffix(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['prefixxsuffix'], $result->segments);
    $this->assertSame(['x' => 'value'], $result->params);
  }
  ...
  public function testAdjacentPlaceholders(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['ab'], $result->segments);
  ...
  public function testPlaceholderAtStart(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['x', 'path'], $result->segments);
    $this->assertSame(['x' => 'value'], $result->params);
  }
  ...
  public function testPlaceholderAtEnd(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['path', 'x'], $result->segments);
    $this->assertSame(['x' => 'value'], $result->params);
  }
  ...
  public function testOnlyPlaceholder(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['x'], $result->segments);
    $this->assertSame(['x' => 'value'], $result->params);
  }
  ...
  public function testPlaceholderWithUnderscore(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['my_var'], $result->segments);
  ...
  public function testPlaceholderWithNumbers(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['var1', 'var2'], $result->segments);
  ...
  public function testSpecialRegexCharsInLiteral(): void {
    ...
    $this->assertNotNull($result);
    $this->assertSame(['path.with" "special+chars', 'id'], $result->segments);
    $this->assertSame(['id' => '123'], $result->params);
  }
  ...
  public function testMatchesSegmentContainingSlash(): void {
    $rule = new PlaceholderRule('/file/{name}');
    $result = $rule->apply(['file', 'a/b']);

    $this->assertNotNull($result);
    $this->assertSame(['file', 'name'], $result->segments);
    $this->assertSame(['name' => 'a/b'], $result->params);
  }

  public function testMatchesNonAsciiLiteral(): void {
    // Placeholder names must be ASCII, but literals and matched values need not be
    $rule = new PlaceholderRule('/日本語/{name}');
    $result = $rule->apply(['日本語', 'あいうえお']);

    $this->assertNotNull($result);
    $this->assertSame(['日本語', 'name'], $result->segments);
    $this->assertSame(['name' => 'あいうえお'], $result->params);
  }
}
